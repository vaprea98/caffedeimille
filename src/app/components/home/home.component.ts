  ...
  template: `
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
      <div class="text-center mb-16">
        <p class="text-lg text-zinc-950 leading-relaxed max-w-2xl mx-auto lobster">
      ...
      <div class="space-y-8">
        <h2 class="text-3xl font-bold text-center text-zinc-950 mb-12 lobster">Scegli una Categoria</h2>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-6">
              <div class="bg-amber-600 p-4 rounded-full shadow-md group-hover:scale-110 transition-transform duration-300">
               <svg class="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1.5">
              ...
              <div class="text-left">
                <h3 class="text-2xl font-bold text-amber-900 mb-2 lobster">Caffetteria</h3>
                <p class="text-amber-900 text-lg">Caffè artigianali e bevande calde</p>
              </div>
            </div>
        ...
        <button
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-6">
              ...
              <div class="text-left">
                <h3 class="text-2xl font-bold text-amber-900 mb-2 lobster">Drinkeria</h3>
                <p class="text-amber-900 text-lg">Cocktail, aperitivi e bevande</p>
              </div>
            </div>
            <svg class="w-6 h-6 text-gray-400 group-hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        ...
        <button
          ...
          class="bg-gradient-to-br from-amber-100 to-yellow-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-amber-100/50 group w-full">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-6">
              <div class="bg-amber-600 p-4 rounded-full shadow-md group-hover:scale-110 transition-transform duration-300">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="text-left">
                <h3 class="text-2xl font-bold text-amber-900 mb-2 lobster">Pasticceria</h3>
                <p class="text-amber-900 text-lg">Dolci della tradizione e torte</p>
              </div>
            </div>
            <svg class="w-6 h-6 text-gray-400 group-hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
