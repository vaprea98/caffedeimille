...
@Component({
  ...
  standalone: true,
  template: `
    <footer class="bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-800 text-white mt-20">
      <div class="max-w-4xl mx-auto px-6 py-12">
        <div class="grid md:grid-cols-3 gap-8 text-center md:text-left">
          <div class="space-y-4">
            <h3 class="text-xl font-bold text-blue-200 mb-4">Contatti</h3>
            <div class="flex items-center justify-center md:justify-start gap-3">
              <svg class="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
              </svg>
              <span class="text-blue-100">Via Dei Mille 33, Torre Annunziata (NA)</span>
            </div>
            <div class="flex items-center justify-center md:justify-start gap-3">
              <svg class="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
              </svg>
              <span class="text-blue-100">+39 081 359 9118</span>
            </div>
          </div>

          <div class="space-y-4">
            <h3 class="text-xl font-bold text-blue-200 mb-4">Orari</h3>
            <div class="flex items-center justify-center md:justify-start gap-3">
              <svg class="w-5 h-5 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="space-y-4">
            <h3 class="text-xl font-bold text-blue-200 mb-4">Seguici</h3>
